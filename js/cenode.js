...
var MODELS = {
  CORE : [
    ...
    "conceptualise a ~ card ~ C that is an entity and has the timestamp T as ~ timestamp ~ and has the value V as ~ content ~ and has the value V as ~ verbatim ~ and has the value W as ~ linked content ~ and has the value V as ~ number of keystrokes ~ and has the timestamp T as ~ start time ~ and has the value W as ~ submit time ~ and has the value L as ~ latitude ~ and has the value M as ~ longitude ~",
...
function CENode(){
  ...
  this.cw_to_ce = function(cw){
    var pre = "";
    var post = "";
    var ce = cw;
    if(cw.match(/has ["'].*["'] as content /i)){
      var splitit = cw.match(/(.* has ["'])(.*)(["'] as content .*)/i);
      pre = splitit[1];
      ce = splitit[2];
      post = splitit[3];
    }
    ...
    ce = ce.replace(/yn bwyta/g, "eats"); 
    ce = ce.replace(/yn chwarae/g, "plays"); 
    ce = ce.replace(/yn cael ei wisgo gan/g, "is worn by"); 
    ce = ce.replace(/yn cynnwys/g, "contains"); 
    ce = ce.replace(/yn cael ei fwyta gan/g, "is eaten by"); 
    ce = ce.replace(/yn cael ei chwarae gan/g, "is played by"); 
    ce = ce.replace(/gwrthrych/g, "object"); 
    ...
    ce = ce.replace(/mae yr? /, "the "); 
    ce = ce.replace(/mae /, "there is a "); 
    ce = ce.replace(/ o\'r enw /, " named "); 
    ce = ce.replace(/sydd yn cael y gwerth/, "that has the value"); 
    ce = ce.replace(/sydd yn cael gwerth/, "that has the value"); 
    ce = ce.replace(/sydd yn cael/, "that has"); 
    ce = ce.replace(/ fel /g, " as "); 
    ce = ce.replace(/sydd yn/g, "that is a"); 
    ce = ce.replace(/ac yn cael y gwerth/g, "and has the value"); 
    ce = ce.replace(/ac yn cael gwerth/g, "and has the value"); 
    ce = ce.replace(/ac yn cael yr?/g, "and has the"); 
    ce = ce.replace(/ac yn cael/g, "and has the"); 
    ce = ce.replace(/yn cael y/g, "has the"); 
    ce = ce.replace(/yn cael/g, "has the"); 
    ce = ce.replace(/ac yn/g, "and is a"); 
  ...
  this.ce_to_cw = function(ce){
    var cw = ce;
    cw = cw.replace(/(.*) is an? ([A-Za-z]*)\. (.*)/g, "Mae $1 yn $2. Mae $3");
    cw = cw.replace(/(.*) is an? ([A-Za-z]*)\./g, "Mae $1 yn $2.");
    cw = cw.replace(/entity/g, "endid"); 
    cw = cw.replace(/locatable thing/g, "peth y gellir ei lleoli"); 
    ...
    cw = cw.replace(/coloured hat/g, "lliw het"); 
    cw = cw.replace(/sport/g, "chwaraeon"); 
    cw = cw.replace(/character/g, "anifail"); 
    cw = cw.replace(/eats/g, "yn bwyta"); 
    cw = cw.replace(/plays/g, "yn chwarae"); 
    cw = cw.replace(/is worn by/g, "yn cael ei wisgo gan"); 
    cw = cw.replace(/contains/g, "yn cynnwys"); 
    cw = cw.replace(/is eaten by/g, "yn cael ei fwyta gan"); 
    cw = cw.replace(/is played by/g, "yn cael ei chwarae gan"); 
    cw = cw.replace(/object/g, "gwrthrych"); 
    cw = cw.replace(/resides in/g, "yn preswylio yn"); 
    cw = cw.replace(/additional contents/g, "cynnwys ychwanegol"); 
    cw = cw.replace(/contains/g, "yn cynnwys"); 
    ...
    cw = cw.replace(/ the ([aeiouy])/g, " yr $1"); 
    cw = cw.replace(/ the /g, " y "); 
    cw = cw.replace(/^the ([aeiouy])/g, "mae yr $1"); 
    cw = cw.replace(/^the /g, "mae y "); 
    ...
    //else if(t.match(/^(\bpwy\b|\bbeth\b) (?:yn)/i)){
      ...
      if(instance == null){
        ...
        if(concept == null){
          ...
          else{return [true, "Dydw i ddim yn gwybod pwy neu beth yw hynny."];}
        }
        else{
  ...
  this.handle_card = function(card){
      ...
      if(from && card.type.name == "ask card"){
        ...
        if(data.data){
          ...
          //var notunderstood = "Sorry; your question was not understood.";
          var notunderstood = "Sori, dydw i ddim yn deall eich cwestiwn.";
          c = "there is a gist card named 'msg_{uid}' that is from the agent '"+name.replace(/'/g, "\\'")+"' and has the timestamp '{now}' as timestamp and has '"+notunderstood+"' as content";
        }
        ...
        if(!data.success){
          //var notunderstood = "Sorry; your input was not understood.";
          var notunderstood = "Sori, dydw i ddim yn deall eich mewnbwn.";
          return node.add_sentence("there is a gist card named 'msg_{uid}' that is from the agent '"+name.replace(/'/g, "\\'")+"' and is to the "+from.type.name+" '"+from.name.replace(/'/g, "\\'")+"' and has the timestamp '{now}' as timestamp and has '"+notunderstood+"' as content and is in reply to the card '"+card.name+"'.");
        }
        var response_card;
